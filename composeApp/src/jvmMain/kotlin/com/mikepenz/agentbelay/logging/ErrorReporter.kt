package com.mikepenz.agentbelay.logging
 ...
 * (see `Theme.FileLogWriter`, ~/.agent-belay/logs/agent-belay.log) and
 * appends a transient [com.mikepenz.agentbelay.state.AppNotice] so users
