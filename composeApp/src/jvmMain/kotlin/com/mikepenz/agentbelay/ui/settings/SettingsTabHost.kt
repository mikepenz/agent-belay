...
fun SettingsTabHost(onShowLicenses: () -> Unit) {
    ...
    SettingsTab(
        ...
        isAntigravityRegistered = ui.isAntigravityRegistered,
        isHermesRegistered = ui.isHermesRegistered,
        ...
        onRegisterAntigravity = viewModel::registerAntigravity,
        onUnregisterAntigravity = viewModel::unregisterAntigravity,
        onRegisterHermes = viewModel::registerHermes,
        onUnregisterHermes = viewModel::unregisterHermes,
